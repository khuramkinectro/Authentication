...
//   console.log("fun clickkkkkk");
//   Posts.find().then(function(doc) {
//     res.render("allpost", { adminGetAllPost: doc });
//   });
// });
//.............................................................//
// router.get("/getPosts", function(req, res) {
//   Posts.find().then(function(doc) {
//     console.log("fun click ho gyyyayyaa");
...
router.get("/adminPosts", function(req, res) {
  Posts.find().then(function(doc) {
    console.log("fun was click");
    res.render("admin", { adminGetAllPost: doc });
  });
});

// router.get("/post/adminPosts", function(req, res) {
//   var resultArray = [];
//   mongo.connect(
//     url,
//     function(err, client) {
